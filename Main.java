...
public class Main {
    ...
    public static void presentation(MatrixOperator mop) {
        ...
        System.out.println("Just beautiful. But don't forget I can only inverse square matrices.");
        promptEnterKey();
        ...
        System.out.println("\nWe get:");
        mop.printMatrix(mop.multiplyMatrices(example3,example4));
        ...
        System.out.println("Press \"ENTER\" one last time to return to main menu and try the options for yourself!");
        promptEnterKey();
    }
