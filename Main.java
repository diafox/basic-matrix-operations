...
public class Main {
    ...
    private final static MatrixOperator mop = new MatrixOperator();
    private final static IOOperator ioop = new IOOperator(input);
    ...
    public static void main(String[] args) {
        ...
        while (gameOn) {
            ...
            boolean optionProvided = false;

            while (!optionProvided) {
                try {
                    ...
                    System.out.println("Option of your choice. This time as integer:");
                }
            }
            ...
            switch (inputOption) {
                case 1:
                    System.out.println("\nFIRST MATRIX");
                    primaryMatrix = ioop.fillMatrix();
                    System.out.println("\nSECOND MATRIX");
                    secondaryMatrix = ioop.fillMatrix();
                    ...
                    ioop.printMatrix(mop.addMatrices(primaryMatrix, secondaryMatrix));
                    break;
                ...
                case 2:
                    ...
                    ioop.printMatrix(mop.scalarMultiplication(primaryMatrix, scalar));
                    break;
                ...
                case 3:
                    ...
                    System.out.println("The multiplication result is:");
                    ioop.printMatrix(mop.multiplyMatrices(primaryMatrix, secondaryMatrix));
                    break;

                case 4:
                    primaryMatrix = ioop.fillMatrix();
                    ioop.printMatrix(mop.transpose(primaryMatrix));
                    break;
                ...
                case 6:
                    ...
                    ioop.printMatrix(mop.inverseMatrix(primaryMatrix));
                    break;
    ...
    public static void presentation(MatrixOperator mop) {
        ...
        ioop.printMatrix(example1scalar);
        ...
        ioop.printMatrix(addedExamples);
        promptEnterKey();
        ...
        System.out.println(ioop.isSparse(addedExamples));
        promptEnterKey();
        ...
        ioop.printMatrix(mop.transpose(addedExamples));
        promptEnterKey();
        ...
        MatrixArray temp = new MatrixArray(filling2);
        Matrix example3 = ioop.convertToSparseArrayMatrix(temp, 10);

        System.out.println("This matrix:");
        ioop.printMatrix(example3);
        ...
        Matrix example4 = ioop.convertToSparseArrayMatrix(temp, 6);
        ioop.printMatrix(example4);
        System.out.println("which is also in the Z-form.");

        System.out.println("\nWe get:");
        Matrix example5 = mop.multiplyMatrices(example3,example4);
        ioop.printMatrix(example5);
